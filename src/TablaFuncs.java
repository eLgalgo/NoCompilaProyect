...
public class TablaFuncs extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TablaFuncs(LinkedList<Funcionalidad> list) {
		crearTablaPersona();
        // Agregamos datos
	...
	private void crearTablaPersona() {
		setResizable(false);
		String[] columnas = {"ID_FUNC", "NOMBRE", "DESC"};
        tabla = new JTable();
	...
	private void agregarDatosLista(DefaultTableModel modelo, LinkedList<Funcionalidad> list) {
